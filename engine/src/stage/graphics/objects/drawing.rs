...
/// Layer that draws all of the objects on the stage and their shadows.
pub struct DrawLayer;

impl graphics::DrawLayer for DrawLayer {
  fn draw(&self, ctx: &mut engine::Context, canvas: &mut graphics::Canvas) {
